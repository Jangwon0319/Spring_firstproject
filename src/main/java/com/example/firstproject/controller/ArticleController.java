...
public class ArticleController {
    ...
    @PostMapping("/articles/create")                    // 폼 데이터를 post 방식으로 전송
    ...
    public String show(@PathVariable Long id, Model model) {     // 매개 변수로 id 받아 오기
    ...
    public String delete(@PathVariable Long id, RedirectAttributes rttr){
        ...
        if (target != null) {
            ...
            // 객체명.addFlashAttribute(넘겨_주려는_키_문자열, 넘겨_주려는_값_객체) : 한 번 쓰고 사라지는 휘발성 데이터 등록
